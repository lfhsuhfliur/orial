      ...
      <div class="column-three">
        ...
        <div class="col3">
          ...
          <div class="inner_area">
            ...
            <img src="<?php echo inkthemes_get_option('inkthemes_wimg1'); ?>" class="featured_img"  alt="fearured image" />
            <?php } else { ?>
            <img src="<?php echo get_template_directory_uri(); ?>/images/featured-img1.jpg" class="featured_img"  alt="fearured image" />
            <?php } ?>
        ...
        <div class="col3">
          ...
          <div class="inner_area">
            ...
            <img src="<?php echo inkthemes_get_option('inkthemes_fimg2'); ?>" class="featured_img"  alt="fearured image" />
            <?php } else { ?>
            <img src="<?php echo get_template_directory_uri(); ?>/images/featured-img2.jpg" class="featured_img"  alt="fearured image" />
            <?php } ?>
        ...
        <div class="col3 last">
          ...
          <div class="inner_area">
            ...
            <img src="<?php echo inkthemes_get_option('inkthemes_fimg3'); ?>" class="featured_img"  alt="fearured image" />
            <?php } else { ?>
            <img src="<?php echo get_template_directory_uri(); ?>/images/featured-img3.jpg" class="featured_img"  alt="fearured image" />
            <?php } ?>
