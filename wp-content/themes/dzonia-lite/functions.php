...
wp_enqueue_script( 'inkthemes-slides', get_stylesheet_directory_uri()."/js/slides.min.jquery.js", array('jquery'));
wp_enqueue_script( 'inkthemes-jcarouselite', get_stylesheet_directory_uri()."/js/jcarousellite_1.0.1.js", array('jquery'));
wp_enqueue_script( 'inkthemes-confu-ui', get_stylesheet_directory_uri()."/js/cufon-yui.js", array('jquery'));
wp_enqueue_script( 'inkthemes-quicksand-confu', get_stylesheet_directory_uri().'/js/mank-sans.cufonfonts.js', array('jquery'));
wp_enqueue_script( 'inkthemes-validate', get_stylesheet_directory_uri().'/js/jquery.validate.min.js', array('jquery'));
wp_enqueue_script( 'inkthemes-verif', get_stylesheet_directory_uri().'/js/verif.js', array('jquery'));
wp_enqueue_script( 'inkthemes-zoombox', get_stylesheet_directory_uri().'/js/zoombox.js', array('jquery'));
