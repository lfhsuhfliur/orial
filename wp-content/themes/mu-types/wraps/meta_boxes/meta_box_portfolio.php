...
$options = array(
	...
	array(
			'name' => esc_html__('Portfolio Detail', 'HK'),
			'type' => 'title',
	),

	array(
			'name' => esc_html__('Client','HK'),
			'desc' => esc_html__('For whom was the portfolio completed.','HK'),
			'id' => 'portfolio_client',
			'std' => '',
			'size' => '60',
			'type' => 'text',
	...
	array(
			'name' => esc_html__('Client URL','HK'),
			'desc' => esc_html__('What is the URL for the Portfolio?','HK'),
