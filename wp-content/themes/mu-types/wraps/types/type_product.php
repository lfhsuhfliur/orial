...
function prod_edit_columns_product($columns)
{
	$newcolumns = array(
		...
		"reference" => esc_html__('Ref.', 'HK'),
		"ontop" => esc_html__('Ontop', 'HK'),
		"qty" => esc_html__('Quantities', 'HK')
...
function prod_custom_columns_product($column)
{
	...
	$qty = get_meta_option('product_quantities');
	...
	switch ($column)
	{
		...
		case "ontop":
		if($ontop) { echo 'ciccio'; } else { echo 'ciaccio'; }
		break;
